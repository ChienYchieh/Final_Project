...
#event.gessage.text接收使用者文字訊息
    ...
    if('雙魚座' in get):
        message = TextSendMessage(text ="希臘神話中雙魚座代表的是阿佛洛狄忒和厄洛斯在水中的化身。阿佛洛狄忒為了逃避大地女神蓋亞之子巨神提豐攻擊而變成魚躲在尼羅河（一說幼發拉底河）。之後她發現忘記帶上自己的兒子厄洛斯一起逃走，於是又上岸找到厄洛斯。為防止與兒子失散，她將兩人腳綁在一起，隨後兩人化為魚形，潛進河中。\n事後我將阿佛洛狄忒首先化身的魚提升到空中成為南魚座，而她和厄洛斯化身的綁在一起的兩條魚則稱為雙魚座。")
    if('金牛座' in get):
    ...
    if('雙子座' in get):
        message = TextSendMessage(text ="雙子座代表的是希臘神話中的天神我與斯巴達王后勒達所生的孿生子(雙胞胎)卡斯托耳和波魯克斯（合稱狄俄斯庫里兄弟），兩人一生充滿無數的英雄壯舉。但他們因和伊達斯和林叩斯分配戰利品時產生矛盾，互相反目成仇並開始決鬥，結果林叩斯被卡斯托耳殺死，卡斯托耳被伊達斯殺死，伊達斯又被波魯克斯殺死。波魯克斯向我哀求如果能讓卡斯托耳復活，他寧願放棄自己的不死之身。我被兄弟倆的友愛精神所感動，將他們提升到天界，成為雙子座。")
    if('白羊座' in get):
        message = TextSendMessage(text ="在希臘神話裡，白羊座指的是一隻有神奇能力的羊，他幫助一對苦難的兄妹脫離險境。可憐的富利科索斯和克拉兄妹，是後母依諾的眼中釘，他不但常虐待這對兄妹，而且計畫要殺死他們。這對兄妹的親生母親涅菲麗知道以後，著急地祈求天帝宙斯解救兄妹倆。因為涅菲麗的虔誠祈求，於是我將一頭全身金毛，長著雙翅的羊送給這對兄妹，好讓兄妹乘著羊飛上天空，脫離依諾的控制。可惜，當他們飛到中途，妹妹克拉卻不慎落入海裡溺死了。於是這頭金羊一邊安慰傷心欲絕的哥哥，一面堅強地朝目的繼續前進。")
    if('獅子座' in get):
        message = TextSendMessage(text ="涅墨亞獅子是半人半蛇的妖怪厄喀德娜生下的，到處吞食生靈。 赫拉克勒斯拿著他的弓箭和他常用的木棒，來到涅墨亞山谷，找到了這頭獅子，先用弓箭射他，箭卻反彈回來，再用木棒打他，粗木棒卻碎裂，原來涅墨亞獅子是刀槍不入的，無論是用石器，銅器還是鐵器，都無法傷害到它。")
    if('處女座' in get):
        message = TextSendMessage(text ="室女座象徵著春神珀耳塞福涅的美麗與純潔，母親養育的麥穗，也成為她手持之物。 另有一說，室女座代表的是正義女神阿斯特莉亞，在對人類感到失望後回到天上變成室女座，而其手中為人類所做之善惡裁判時所用的天秤則成為了天秤座。")
    if('天秤座' in get):
        message = TextSendMessage(text ="天秤座是希臘神話中的正義女神阿斯特莉亞在為人類所做善惡裁判時所用的天平，阿斯特莉亞一隻手持天平，一隻手握斬除邪惡的劍。 為求公正，所以眼睛皆矇著。 從前的眾神和人類是和平共處於大地上，神雖擁有永遠的生命，但人類壽命有限。 因此寂寞的神只有不斷創造人類，然而那時的人好爭鬥，惡業橫行，眾神在對人類失望之餘回到天上。")
    if('摩羯座' in get):
    ...
    if('巨蟹座' in get):
        message = TextSendMessage(text ="而「巨蟹座」（Cancer）也是起源於古希臘的神話，傳說宙斯的私生子海格力斯和萊爾納的九頭大蛇（長蛇座）戰鬥時，海格力斯的死對頭赫拉派出巨蟹偷偷攻擊海格力斯的腳，結果海格力斯一怒之下把巨蟹踩成碎片，之後赫拉將巨蟹的碎片抬起至天空，成為巨蟹座。")
    if('射手座' in get):
        message = TextSendMessage(text ="有一天海格拉斯和族人起衝突，被追殺的他就逃入肯農家中，憤怒的海格拉斯就瞄準半馬半人族頻頻放箭，卻不知老師肯農也混在其中，而射到他的腳。 因箭端沾了不死之身，所以無法從痛苦中解放。 巨人神普羅米修斯乃廢了其不死之身，讓他安詳而死，而成為天上的射手座。")
    if('黑人問號' in get):
